    ...
    <main>
        ...
        <div className="relative mx-auto flex min-h-[78dvh] max-w-6xl flex-col justify-end px-4 pb-16 pt-28 sm:px-6 sm:pb-20">
          <div className="stagger-in max-w-xl">
            ...
            <p className="mt-5 max-w-md text-base leading-relaxed text-fg/80 sm:text-lg">
              Burgers, shawarma, paratha rolls and loaded fries — fried hot, packed, and sent across Jhang.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <button type="button" onClick={orderNow} className="inline-flex h-12 items-center rounded-lg bg-primary px-5 text-sm font-semibold text-primary-fg transition-transform duration-150 hover:bg-primary-hot active:scale-[0.96]">
                Order now
              </button>
              <a href="#menu" className="inline-flex h-12 items-center gap-2 rounded-lg px-5 text-sm font-medium text-fg ring-1 ring-fg/25 transition-colors hover:bg-fg/10">
                See the menu
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <div className="flex items-end justify-between gap-4">
          <div>
            <p className="text-xs font-semibold tracking-[0.16em] text-subtle uppercase">Popular</p>
            <h2 className="mt-2 font-display text-4xl tracking-wide sm:text-5xl">What Jhang orders.</h2>
          </div>
      ...
      <section id="visit" className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <div className="grid overflow-hidden rounded-xl bg-surface shadow-[var(--shadow-card)] md:grid-cols-2">
          ...
          <div className="flex flex-col justify-center px-6 py-10 sm:px-10">
            ...
            <a href={mapsLink} target="_blank" rel="noopener noreferrer" className="mt-3 inline-flex h-12 w-fit items-center rounded-lg px-5 text-sm font-medium text-fg ring-1 ring-border transition-colors hover:bg-elevated">
              Open in Google Maps
            </a>
            <Link to="/order" className="mt-3 inline-flex h-12 w-fit items-center rounded-lg px-5 text-sm font-medium text-fg ring-1 ring-border transition-colors hover:bg-elevated">
